...
const projects = [
  {
    name: 'React Native Expo - Agenda de Notas',
  ...
  {
    name: 'React Native Expo - Cálculo de Compras',
  ...
  {
    name: 'React + TypeScript + Vite - Cálculo de Compras',
  ...
  {
    name: 'React + TypeScript + Vite - Comunidad CS 1.6',
